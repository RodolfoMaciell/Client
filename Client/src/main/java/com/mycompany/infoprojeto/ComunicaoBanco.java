...
public class ComunicaoBanco {
     ...
     */
    public ComunicaoBanco(String host, String database, String user, String pass) {
        this.pass = pass;
        this.user = user;
        this.host = host;
    ...
    public Connection obterConexao() throws ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException {
